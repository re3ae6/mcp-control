...
TOOL_CAPABILITIES={"ls":"files.list","image_list":"files.list","read":"files.read","search":"files.search","context":"files.context","history":"files.history","changes_list":"files.changes","write":"files.write","mkdir":"files.mkdir","run":"terminal.run","cancel":"terminal.cancel","session_start":"terminal.background","session_run":"terminal.run","session_poll":"terminal.poll","session_list":"terminal.list","session_kill":"terminal.kill","terminal_open":"terminal.run","terminal_run":"terminal.run","terminal_send":"terminal.run","terminal_read":"terminal.read","terminal_list":"terminal.list","terminal_close":"terminal.cancel","system_info":"terminal.process","health":"terminal.process","process_list":"terminal.process","location":"device.location","camera_photo":"device.camera","screenshot":"device.camera","image_process":"files.read","image_read":"files.read","text_extract":"files.read","sms_send":"device.sms","sms_inbox":"device.sms","clipboard_get":"device.clipboard","clipboard_set":"device.clipboard","notify":"device.notifications","toast":"device.notifications","tts_speak":"device.tts","share":"device.share","open_url":"network.internet","download":"network.internet","public_ip":"network.internet","weather":"network.internet","speedtest":"network.internet","qrcode":"network.internet","cloud_sync":"network.internet","delete":"dangerous.delete","process_kill":"dangerous.kill","smart_install":"dangerous.install","cron_list":"terminal.process","cron_add":"terminal.background","cron_remove":"dangerous.kill","git_pr":"git.diff","diff":"git.diff"}
...
IMAGE_FILE_TOOLS={"image_list":"files.list","image_process":"files.read","image_read":"files.read","text_extract":"files.read"}
...
AREA_TOOL_ACTIONS={"files":("ls","read","search","context","history","changes_list","write","mkdir","image_list","image_process","image_read","text_extract"),"git":("git_pr","diff","run"),"terminal":("run","cancel","session_start","session_run","session_poll","session_list","session_kill","terminal_open","terminal_run","terminal_send","terminal_read","terminal_list","terminal_close","system_info","health","process_list","cron_list","cron_add","cron_remove"),"network":("open_url","download","public_ip","weather","speedtest","qrcode","cloud_sync"),"mcp":("run","session_start","session_run","session_poll","session_list","session_kill","terminal_run","terminal_send","terminal_read","terminal_list","terminal_close"),"device":("location","camera_photo","screenshot","sms_send","sms_inbox","clipboard_get","clipboard_set","notify","toast","tts_speak","share"),"dangerous":("delete","process_kill","smart_install","cron_remove")}
