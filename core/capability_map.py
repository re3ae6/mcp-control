...
IMAGE_FILE_TOOLS={"image_list":"files.list","image_process":"files.read","text_extract":"files.read"}
...
AREA_TOOL_ACTIONS={"files":("ls","read","search","context","history","changes_list","write","mkdir","image_list","image_process","text_extract"),"git":("git_pr","diff","run"),"terminal":("run","cancel","session_start","session_run","session_poll","session_list","session_kill","terminal_open","terminal_run","terminal_send","terminal_read","terminal_list","terminal_close","system_info","health","process_list","cron_list","cron_add","cron_remove"),"network":("open_url","download","public_ip","weather","speedtest","qrcode","cloud_sync"),"mcp":("run","session_start","session_run","session_poll","session_list","session_kill","terminal_run","terminal_send","terminal_read","terminal_list","terminal_close"),"device":("location","camera_photo","screenshot","sms_send","sms_inbox","clipboard_get","clipboard_set","notify","toast","tts_speak","share"),"dangerous":("delete","process_kill","smart_install","cron_remove")}
